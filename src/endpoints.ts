...
function categorize(path: string): string {
  if (path.startsWith("/v1/weather") || path.startsWith("/v1/pollen") || path.startsWith("/v1/air-quality")) return "Weather & Climate";
  if (path.startsWith("/v1/transport") || path.startsWith("/v1/transit") || path.startsWith("/v1/infrastructure") || path.startsWith("/v1/road-conditions")) return "Transport & Infrastructure";
  if (path.startsWith("/v1/rates") || path.startsWith("/v1/currencies") || path.startsWith("/v1/gdp") || path.startsWith("/v1/prices") || path.startsWith("/v1/labor") || path.startsWith("/v1/housing") || path.startsWith("/v1/income") || path.startsWith("/v1/trade") || path.startsWith("/v1/wages") || path.startsWith("/v1/public-finance") || path.startsWith("/v1/money-supply") || path.startsWith("/v1/financial-series") || path.startsWith("/v1/energy") || path.startsWith("/v1/statistics")) return "Economy & Finance";
  if (path.startsWith("/v1/health") || path.startsWith("/v1/healthcare") || path.startsWith("/v1/public-health") || path.startsWith("/v1/nutrition")) return "Health & Medicine";
  if (path.startsWith("/v1/environment") || path.startsWith("/v1/hydrology") || path.startsWith("/v1/ocean") || path.startsWith("/v1/water-quality") || path.startsWith("/v1/contaminated") || path.startsWith("/v1/bathing") || path.startsWith("/v1/geology") || path.startsWith("/v1/climate") || path.startsWith("/v1/agriculture")) return "Environment & Nature";
  if (path.startsWith("/v1/parliament") || path.startsWith("/v1/police") || path.startsWith("/v1/crisis") || path.startsWith("/v1/elections") || path.startsWith("/v1/crime")) return "Government & Safety";
  if (path.startsWith("/v1/social-insurance") || path.startsWith("/v1/parental-leave")) return "Social Insurance";
  if (path.startsWith("/v1/schools") || path.startsWith("/v1/education") || path.startsWith("/v1/qualifications")) return "Education";
  if (path.startsWith("/v1/jobs") || path.startsWith("/v1/taxonomy")) return "Jobs & Labor Market";
  if (path.startsWith("/v1/companies") || path.startsWith("/v1/vat")) return "Business & Companies";
  if (path.startsWith("/v1/library") || path.startsWith("/v1/heritage") || path.startsWith("/v1/museum") || path.startsWith("/v1/radio")) return "Culture & Media";
  if (path.startsWith("/v1/municipalities") || path.startsWith("/v1/population") || path.startsWith("/v1/demographics") || path.startsWith("/v1/names")) return "Demographics & Municipalities";
  if (path.startsWith("/v1/telecom") || path.startsWith("/v1/power-grid") || path.startsWith("/v1/open-data")) return "Telecom & Data";
  if (path.startsWith("/v1/geo")) return "Geography";
  if (path.startsWith("/v1/tourism") || path.startsWith("/v1/destinations")) return "Tourism";
  return "Other";
}
